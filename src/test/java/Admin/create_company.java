...
public class create_company extends BaseClass{
    ...
    public void createcompany() {
        ...
        wd.get("https://app.influitives.com/users/sign_in");
        ...
        wd.findElement(By.id("company_name")).sendKeys("sanityjan7");
        try { Thread.sleep(2000l); } catch (Exception e) { throw new RuntimeException(e); }
        wd.findElement(By.id("company_subdomain")).click();
        wd.findElement(By.id("company_subdomain")).clear();
        wd.findElement(By.id("company_subdomain")).sendKeys("sanityjan7");
        try { Thread.sleep(2000l); } catch (Exception e) { throw new RuntimeException(e); }
