...
public class approval_feedback {
    FirefoxDriver wd;
    ...
    public void approval_with_feedback() {
        ...
        wd.findElement(By.name("description")).sendKeys("Approval Challenge with Feedback. This is to test approving an advocates action with admin feedback.");
        try { Thread.sleep(3000l); } catch (Exception e) { throw new RuntimeException(e); }
