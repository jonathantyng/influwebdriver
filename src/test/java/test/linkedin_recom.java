...
public class linkedin_recom extends BaseClass{
    ...
    public void linkedin_recom() {
        ...
        //Add linkedin recommendation challenge
        ...
        wd.findElement(By.name("name")).sendKeys("LinkedIn Challenge");
        try { Thread.sleep(2000l); } catch (Exception e) { throw new RuntimeException(e); }
        ...
        wd.findElement(By.name("headline")).sendKeys("LinkedIn Challenge");
        try { Thread.sleep(2000l); } catch (Exception e) { throw new RuntimeException(e); }
        wd.findElement(By.name("description")).click();
        wd.findElement(By.name("description")).clear();
        wd.findElement(By.name("description")).sendKeys("LinkedIn Challenge is amazing. Complete this challenge.");
        try { Thread.sleep(2000l); } catch (Exception e) { throw new RuntimeException(e); }
        ...
        wd.findElement(By.xpath("//img[@alt='Linkedin_product_recommendation']")).click();
        try { Thread.sleep(2000l); } catch (Exception e) { throw new RuntimeException(e); }
        wd.findElement(By.name("params.company_name")).click();
        wd.findElement(By.name("params.company_name")).clear();
        wd.findElement(By.name("params.company_name")).sendKeys("influitive");
        try { Thread.sleep(2000l); } catch (Exception e) { throw new RuntimeException(e); }
