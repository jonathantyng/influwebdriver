...
public class corporate_confirm extends BaseClass{
    ...
    public void corporateconfirm() {
        ...
        wd.findElement(By.cssSelector("#c45 > label > input[name=\"subject\"]")).click();
        wd.findElement(By.cssSelector("#c45 > label > input[name=\"subject\"]")).clear();
        wd.findElement(By.cssSelector("#c45 > label > input[name=\"subject\"]")).sendKeys("The second question");
        try { Thread.sleep(3000l); } catch (Exception e) { throw new RuntimeException(e); }
        wd.findElement(By.cssSelector("#add-stage > img.icon")).click();
        try { Thread.sleep(3000l); } catch (Exception e) { throw new RuntimeException(e); }
        wd.findElement(By.xpath("//img[@alt='Corporate_confirmation']")).click();
